...
cp src/lib/{sync,syncBridge,syncClient,syncStorage,syncTransport,alarmPlan,agenda,notifications,recurrence,categories,prayerTimes,tasks,taskLists,gcalColor}.ts ../../mobile/src/lib/
